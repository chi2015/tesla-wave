...
class Guard {
    ...
    var $none_chek_dir=array('UserFiles','pda','install','1cManager','backup','files','csv','editors','Packs','doc');
    var $src=array('php','html','tpl','js');
    var $update_url='http://www.phpshop.ru/update/guard/update.php';
    var $backup_path='UserFiles/File/';
    ...
    function Guard($dir_global) {
        ...
        $this->stop_message=$this->SysValue['lang']['guard']['guard_stop_message'];
    ...
    function license() {
        ...
        $this->support=$license['License']['DomenLocked'];
    }
    ...
    function update() {
        ...
        // Проверка лицензии
        $this->license();
        $this->update_url.="?server=".$_SERVER['SERVER_NAME']."&from=".$this->support."&version=".$this->SysValue['upload']['version'];
