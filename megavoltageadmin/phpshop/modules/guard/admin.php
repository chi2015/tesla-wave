...
$Guard = &new Guard("../../../");
$Guard->backup_path='../../../UserFiles/File/';
...
* Ссылка для загрузки файлов из карантина: http://'.$_SERVER['SERVER_NAME'].$quarantine_name;
                ...
                $PHPShopMail=&new PHPShopMail('guard@phpshop.ru',$PHPShopSystem->getParam('admin_mail'),$zag,$content);
...
направлены по адресу '.$PHPShopSystem->getParam('admin_mail').'
    </pre>';
