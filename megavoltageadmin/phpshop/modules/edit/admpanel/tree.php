...
<html>
    <head>
        ...
        <LINK href="<?=$_classPath.'admpanel/'?>skins/<?=$PHPShopSystem->getSerilizeParam("admoption.theme")?>/dtree.css" type=text/css rel=stylesheet>
        <SCRIPT language=JavaScript1.2 src="<?=$_classPath.'admpanel/'?>java/dtree.js" type=text/javascript></SCRIPT>
        <script language="JavaScript1.2" src="<?=$_classPath.'admpanel/'?>java/phpshop.js" type="text/javascript"></script>
    </head>
