<table cellpadding="5" cellspacing="0"  width="100%" style="margin-bottom: 10px; border:outset;border-width: 1px;border-color:Silver">
  <tr>
    <td>
      <a class="highslide" onclick="return hs.expand(this)" href="@productImgBigFoto@" target="_blank" getParams="null" title="@productName@">
          <img src="@productImg@" lowsrc="images/shop/no_photo.gif"   alt="@productName@" title="@productName@" border="0"></a>
    </td>
     <td>
      <!-- Вывод имени товара -->
