...
DROP TABLE IF EXISTS `phpshop_modules_stat_system`;
CREATE TABLE IF NOT EXISTS `phpshop_modules_stat_system` (
  `color` varchar(10) NOT NULL default '',
  `serial` varchar(64) NOT NULL default ''
) ENGINE=MyISAM DEFAULT CHARSET=cp1251;

--
-- Дамп данных таблицы `phpshop_modules_stat_system`
--

INSERT INTO `phpshop_modules_stat_system` VALUES ('#AA9765', '');
