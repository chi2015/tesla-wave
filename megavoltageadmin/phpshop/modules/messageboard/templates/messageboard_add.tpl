    ...
    <div class="art-post-body">
        <div class="art-post-inner">
            <div class="art-postcontent">
                <!-- article-content -->
                <span class="breadcrumbs pathway"><a class="pathway" href="/">Главная</a> <img alt="" src="images/arrow.png"> <a class="pathway" href="/board/">Доска объявлений</a> <img alt="" src="images/arrow.png"> Форма объявления</span>
                <!-- /article-content -->
            </div>
...
<div class="art-post">
    <div class="art-post-body">
        <div class="art-post-inner">
            <h2 class="art-postheader"><img src="images/postheadericon.png" alt="postheadericon" width="30" height="23" /> Форма объявления</h2>
                ...
                <form method="post" name="forma_gbook">
                    <table cellpadding="5" cellspacing="1" border="0" class="standart">
                        ...
                        <tr>
                            ...
                            <td valign="top"><textarea style="width:300px;" name="content_new" maxlength="100" ></textarea>
                                <img src="images/shop/flag_green.gif" alt="" width="16" height="16" border="0"> </td>
                        </tr>
                        <tr>
