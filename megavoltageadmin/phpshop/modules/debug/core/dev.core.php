...
class PHPShopDev extends PHPShopCore {
    ...
    function modules_list() {
        ...
        $PHPShopOrm = new PHPShopOrm($this->getValue('base.table_name2'));
    ...
    function error_log() {
        ...
        $this->set('pageContent', PHPShopText::h1('Отладочные сообщения').$clean_button.PHPShopText::table($log,$cellpadding=3,$cellspacing=1,$align='center',$width='98%',$bgcolor=false,$border=1).$clean_button,true);
