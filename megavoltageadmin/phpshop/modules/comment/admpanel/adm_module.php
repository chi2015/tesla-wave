...
function actionStart() {
    ...
    $PHPShopGUI->setHeader("Настройка модуля 'Comment'","Настройки",$PHPShopGUI->dir."img/i_display_settings_med[1].gif");
    ...
    $Tab1=$PHPShopGUI->setField("Расположение блока комментариев:",
            $PHPShopGUI->setCheckbox("enabled_new",1,"Вывод блока на сайте",$enabled).$PHPShopGUI->setSelect("flag_new",$Select,100,1),"left",5);

     $Info='
     Для произвольного размещения формы вывода последних комментариев отключите опцию вывода блока на сайте и используйте переменную @lastcommentForma@
