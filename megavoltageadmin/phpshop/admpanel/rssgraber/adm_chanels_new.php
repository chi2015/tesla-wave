...
$PHPShopGUI->title="Создание Нового Канала RSS";
...
function actionStart() {
    ...
    $PHPShopGUI->setHeader("Создание Нового Канала RSS","Укажите данные для записи в базу.",$PHPShopGUI->dir."img/i_subscription_med[1].gif");
...
<IMG onclick="popUpCalendar(this, product_edit.end_date_new, \'dd-mm-yyyy\');" height=16 hspace=3 src="../icon/date.gif" width=16 border=0 align="absmiddle"></div>';
    ...
    $Tab1=$PHPShopGUI->setField("Адрес ленты:",$PHPShopGUI->setInput("text","link_new",$link,"none",300),"none").
            $PHPShopGUI->setField("Запись в день:",$PHPShopGUI->setSelect("num_new",$Select1,50),"left",5).
            $PHPShopGUI->setField("Кол-во записей за раз:",$PHPShopGUI->setInput("text","news_num_new",10,"left",100),"none",5).
            $PHPShopGUI->setLine().
            $PHPShopGUI->setField("Срок работы (dd-mm-yyyy):",$DateField,"none").
            $PHPShopGUI->setField("Статус:",$PHPShopGUI->setRadio("enabled_new",1,"Включено","checked","left").$PHPShopGUI->setRadio("enabled_new",0,'Отключено',false),"none");
