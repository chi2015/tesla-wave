...
function actionStart() {
    ...
    if(isset($_POST['reg'])) {
        ...
        $Tab1.=$PHPShopGUI->setField('Инструкция по оплате',$PHPShopGUI->setTextarea('sms',$db['sms'],$float="none",$width="210px",$height="100px"));
    }
    else {
        $tab_caption='Шаг-1';
        $Tab1.=$PHPShopGUI->setButton("Добровольная регистрация",'key.png',"230px","px",$float="none",
                $onclick="GhekReg();");
    }
...
';
    ...
    $Tab2=$PHPShopGUI->setInfo($Info,false,"95%");

    $PHPShopGUI->setTab(array($tab_caption,$Tab1,280),array('Описание',$Tab2,280));
