...
//echo 'q'.file_exists($font).'q';
//echo  $size.' | '.$angle.' | '.$font.' | '.$text;
...
//echo 'q'.file_exists("../../..".$option['watermark_big']['big_png_file']).'q';
...
//echo 'q'.file_exists("../../..".$option['watermark_small']['small_png_file']).'q';
...
//        echo $option['watermark_ishod']['ishod_png_file'];        
        ...
        elseif ($option['watermark_ishod']['ishod_type'] == "png") {
            ...
            echo 'q'.file_exists("../../../..".$option['watermark_ishod']['ishod_png_file']).'q';
            $img = newWatermarkPng( $img,
                    $watermark_img_obj,
