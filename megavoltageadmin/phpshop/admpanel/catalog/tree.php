...
<html>
    ...
    <body bottommargin="0" rightmargin="0" topmargin="0" leftmargin="0" bgcolor="#ffffff">
        <div style="padding:10px">
            ...
            $CatalogTree->addcat(1000,3000,'Главное меню сайта','admin_cat_content.php?pid=1000');
            $CatalogTree->addcat(2000,3000,'Начальная страница','admin_cat_content.php?pid=2000');
            $CatalogTree->create();
            $CatalogTree->disp();
            ?>
        </div>
