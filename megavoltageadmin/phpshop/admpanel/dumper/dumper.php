...
<INPUT TYPE=button VALUE='Закрыть' onClick=\"return onCancel();\" class=but >
";
...
<INPUT TYPE=button VALUE='Закрыть' onClick=\"window.close();\" class=but>";
	...
	function main(){
		...
		<INPUT TYPE=button VALUE=Отмена onClick=\"return onCancel();\" class=but name=btnLang>";
...
<TR>
<TD><span name=txtLang id=txtLang>Фильтр таблиц</span>:<img src="../img/btn_help[1].gif" alt="" border="0" onclick="getInfo()" align="absmiddle" hspace="5" style="cursor: pointer;"></TD>
