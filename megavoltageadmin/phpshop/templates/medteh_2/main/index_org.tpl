        ...
        <div class="bottom">
          <div class="top">
            <div id="holder">
              ...
              <div id="maincolumn">
                <div class="nopad">
                  <div style="margin:10px auto 30px"><span class="breadcrumbs pathway">Главная</span></div>
                  <div class="componentheading">@mainContentTitle@</div>
                  <table class="blog" cellpadding="0" cellspacing="0">
                    <tr>
                      <td valign="top"><div>
                          <table class="contentpaneopen">
                            <tr>
                              <td valign="top" colspan="2">@mainContent@</td>
                            </tr>
                          </table>
