...
@cloud@
          ...
          <div class="art-layout-cell art-content">
            ...
            <div class="art-post">
              <div class="art-post-body">
                <div class="art-post-inner">
                  <h2 class="art-postheader"><img src="images/postheadericon.png" alt="postheadericon" width="30" height="23" /> @mainContentTitle@</h2>
            ...
            <div class="art-post">
              <div class="art-post-body">
                <div class="art-post-inner">
                  <h2 class="art-postheader"><img src="images/postheadericon.png" alt="postheadericon" width="30" height="23" /> Новости</h2>
                  <div class="art-postmetadataheader">
                    <div class="art-postheadericons art-metadata-icons"> </div>
                  </div>
                  <div class="art-postcontent">
              ...
              <div class="art-block-body">
                ...
                <div class="art-blockcontent">
                  ...
                  <div class="art-blockcontent-body">
                    ...
                    <p>
                          <ul class="mostread">
                             <li class="mostread"> <a href="http://www.phpshop.ru/docs/product5.html" class="mostread"> PHPShop Pro 1C </a> </li>
                             <li class="mostread"> <a href="http://www.phpshop.ru/docs/product.html" class="mostread"> PHPShop Enterprise </a> </li>
                             <li class="mostread"> <a href="http://www.phpshop.ru/docs/product2.html" class="mostread"> PHPShop Start </a> </li>
                          </ul>
                      </p>
                    <!-- /block-content -->
                    <div class="cleared"></div>
