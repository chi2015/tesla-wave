...
<div id="header">
  ...
  <div id="menu">
    <ul class="left" style="display: none;">
      ...
      <li id="catalog"><a class="top"><?php echo $text_catalog; ?></a>
        <ul>
          ...
          <li><a href="http://tesla-wave.ru/megavoltageadmin2/admin/instantgallery"><?php echo $text_gallery; ?></a></li>
      ...
      <li id="texts"><a class="top"><?php echo $text_textsedit; ?></a>
      	<ul>
      		<li><a href="http://tesla-wave.ru/megavoltageadmin2/admin/hello"><?php echo $text_hello; ?></a></li>
      	</ul>
      </li>
    ...
    <ul class="right" style="display: none;">
      <li id="store"><a href="http://tesla-wave.ru" target="_blank" class="top"><?php echo $text_mainpage; ?></a>
